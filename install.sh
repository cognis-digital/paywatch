#!/usr/bin/env sh
# Universal installer for paywatch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/paywatch.git"
echo "Installing paywatch ..."
