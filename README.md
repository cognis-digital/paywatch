...
[![PyPI](https://img.shields.io/pypi/v/cognis-paywatch.svg)](https://pypi.org/project/cognis-paywatch/)
[![CI](https://github.com/cognis-digital/paywatch/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/paywatch/actions)
...
PAYWATCH exists for one job — recurring-charge and subscription detector from bank/plaid csv — and does it without a SaaS bill or heavyweight setup.
...
```bash
paywatch --version
paywatch scan .                      # scan the current project
paywatch scan . --format json
paywatch scan . --fail-on high       # non-zero exit for CI gates
paywatch mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Rocket Money**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`paywatch` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
