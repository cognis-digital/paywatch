...
import argparse, sys
from paywatch.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="paywatch", description="PAYWATCH — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from paywatch.mcp_server import serve
        return serve()
    if args.cmd == "scan":
