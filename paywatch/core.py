"""PAYWATCH core — Recurring-charge and subscription detector from bank/Plaid CSV."""
...
RULES = [
    ("PAY-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("PAY-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("PAY-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
